...
public class StudentInfoMain {
    public static void main(String[] args) {
        StudentInfo s1=new StudentInfo(1,"chandu",24,987898789);
        StudentInfo s2=new StudentInfo(2,"reddy",25,543245653);
        StudentInfo s3=new StudentInfo(3,"chikku",23,234543223);
        StudentInfo s4=new StudentInfo(4,"etikala",28,999999999);
        StudentInfo s5=new StudentInfo(5,"chandu reddy",25,234567897);
